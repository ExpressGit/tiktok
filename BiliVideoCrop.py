...
LastEditTime: 2023-06-24 20:25:47
...
class BiliVideoCrop(object):
    ...
    def get_all_video_list(self,date_str=None):
        ...
        return Bili_video_list,Bili_srt_list
    
    def remove_bili_logo(self,video_list):
        '''
        去除bili视频的水印
        '''
        video_new_list = []
        ...
        for video_file in tqdm(video_list):
            new_video_file = video_util.remove_bili_logo(video_file)
...
if __name__ == '__main__':
    ...
    # date_str = '2023-06-18'
    video_list,srt_list = bili_crop.get_all_video_list(date_str)
    new_video_list = bili_crop.remove_bili_logo(video_list)
