...
dir = '/root/video_download/bili/浅影阿_/2023-05-27' #Place video directory here
video_name = 'a.mp4' #Place video name here
...
os.chdir(dir)
video = cv2.VideoWriter('outpu.avi', 0, int(vid.get(cv2.CAP_PROP_FPS)), (int(vid.get(cv2.CAP_PROP_FRAME_WIDTH)), int(vid.get(cv2.CAP_PROP_FRAME_HEIGHT))))
